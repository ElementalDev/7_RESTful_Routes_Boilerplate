...
# This will get a HTML form and display a specific set of information within the form based on the
# id that is inputted within the URL
get "/books/:id/edit" do
  "Return form for adding a book"
end

# When the user clicks the submit button of the form (displayed above), the put will retrieve
# the information that the user has inputted and will update the record for that specific ID
put "/books/:id/edit" do
  "The information has been updated in storage"
end

# DELETE ROUTE

# When the user sends delete or clicks a button that the controller uses to send delete, the
# specific record of data (selected using ID) is deleted from the storage medium
delete "/books/:id/delete" do
  "The information has been deleted from storage"
end
